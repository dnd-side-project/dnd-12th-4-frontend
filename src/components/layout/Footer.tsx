...
export default function Footer() {
  ...
  return (
    <div className="fixed bottom-0 z-50 flex h-[92px] w-full max-w-screen-lg items-center justify-between rounded-tl-[28px] rounded-tr-[28px] border border-outline bg-white">
